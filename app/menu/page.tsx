...
export default function MenuPage() {
  ...
  return (
    <div className=" px-3 lg:px-8 py-5 sm:py-6 lg:py-8 max-w-7xl xl:max-w-[1500px] mx-auto  font-sans">
      {/* Header Section */}
      <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4 md:gap-6 w-full lg:mb-6">
      ...
      <div className="flex gap-3 sm:gap-4 pt-3 overflow-x-auto pb-4 sm:pb-5   sm:mx-0 sm:px-0 lg:justify-center">
      ...
      {/* Dish Grid */}
      <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5 lg:gap-5 mt-6 sm:mt-8">
